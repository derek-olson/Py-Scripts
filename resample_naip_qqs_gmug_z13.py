...
workspace = r"I:\GMUG\tiles\39108" #where all the quarter quads are stored
...
#Dummy raster
Dummyrast = arcpy.sa.Raster(r'H:\workspace\TEUI\GMUG\dummyRaster.img') #create this and make sure bigger than extent

# Project area to limit unneccessary processing 
ProjectArea = r'H:\workspace\TEUI\GMUG/GMUG_ALP_zone12_Buffer_envelope.shp'
...
for rast in allRasters:
	#Get output Names
	rastName = os.path.basename(rast).split(".")[0]
	print rastName
	clippedname = resampleFolder + "/" + rastName +"_clipped.tif"
	composite_name = resampleFolder + "/" + rastName +"_5m.img"
	integer_name = resampleFolder + "/" + rastName + "_5m_int8.img"
